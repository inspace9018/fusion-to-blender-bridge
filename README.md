...
>
> Two paid add-ons cover what sits either side of it. The bridge is complete without them.
>
> | | What it does | |
> |---|---|:---:|
...
**함께 고친 것**
- **조인트** — 조인트로 만들어진 Empty가 실제로 해당 부품을 움직이도록 수정. 이전에는 표시만 되고
  부품은 따라가지 않았습니다(As-Built Joint는 좌표가 비어 조용히 원점에 놓이던 문제)
