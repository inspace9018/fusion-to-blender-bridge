...
_STRINGS = {
    ...
    "sync_selected":        {"ko": "선택만 다시 동기화 ({n})",
                             "en": "Sync Selected ({n})"},
    "sync_selected_requested": {"ko": "선택한 {n}개만 다시 동기화 요청",
                             "en": "Re-sync requested for {n} selected"},
    ...
    "ocp_confirm1":         {"ko": "서드파티 패키지 cadquery-ocp(OpenCascade)를",
                             "en": "Installs the third-party cadquery-ocp package"},
    "ocp_confirm1b":        {"ko": "PyPI에서 내려받아 설치합니다 (약 수백 MB).",
                             "en": "(OpenCascade) from PyPI (~hundreds of MB)."},
